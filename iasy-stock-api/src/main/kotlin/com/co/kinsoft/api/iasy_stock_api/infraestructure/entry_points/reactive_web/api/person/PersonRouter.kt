...
class PersonRouter(private val handler: PersonHandler) {
    ...
    @Bean
    fun personRoutes(): RouterFunction<ServerResponse> = RouterFunctions.nest(path("/api/persons"),
        RouterFunctions.route()
            ...
            .GET("/search/by-identification", handler::findByIdentification)
            .GET("/search/by-type", handler::findByType)
